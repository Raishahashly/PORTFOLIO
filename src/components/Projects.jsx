...
const projects = [
  ...
  },
  {
    ...
    description:
      'A full-stack mobile app that incentivises household waste recycling. Green Army workers collect waste, verify it via Google Vertex AI (Gemini 2.0 Flash), and assign reward points. Users redeem points through a QR-based system.',
    link: null,
    github: 'https://github.com/Raishahashly/PACHAPP.git',
    badge: 'AI + Mobile',
    badgeClass: 'badge-emerald',
    techStack: 'React Native (Expo), FastAPI, MongoDB, JWT auth, Vertex AI',
